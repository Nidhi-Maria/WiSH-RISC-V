...
// Edit the code here begin ---------------------------------------------------
    ...
    always @(*) begin
        if (funct3 == 3'h0) load_control = `LB;
        else if (funct3 == 3'h1) load_control = `LH;
        else if (funct3 == 3'h2) load_control = `LW;
        else if (funct3 == 3'h4) load_control = `LBU;
        else if (funct3 == 3'h5) load_control = `LHU ;
        else load_control = `LD_NOP;
    end
